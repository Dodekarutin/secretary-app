...
const ja: Dict = {
  ...
  "settings.dataSource.local": "ローカル（localStorage）",
  "settings.dataSource.indexeddb": "IndexedDB（ブラウザ保存）",
  ...
  "settings.dataSource.originWarning":
    "⚠️ データはオリジン（プロトコル+ドメイン+ポート）単位で分離されます。異なるポートで起動すると別のデータになります。",
  "settings.backup": "バックアップ / リストア",
  "settings.backup.export": "エクスポート（ダウンロード）",
  "settings.backup.import": "インポート（復元）",
  "settings.backup.selectFile": "ファイルを選択",
  "settings.backup.importing": "インポート中...",
  "settings.backup.importSuccess": "データを復元しました。ページをリロードします。",
  "settings.backup.importError": "インポートに失敗しました",
  "settings.backup.description": "異なるポートや別のブラウザでデータを使うには、エクスポートしてからインポートしてください。",
  "settings.ai": "AI 設定",
